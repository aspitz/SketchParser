...
Pod::Spec.new do |s|
  ...
  s.default_subspecs = 'SketchDocument', 'Sketch'

  s.subspec 'SketchDocument' do |ss|
    ss.source_files = "SketchParser/Sketch Document/**/*.swift"
  end

  s.subspec 'Sketch' do |ss|
    ss.source_files = "SketchParser/Sketch/**/*.swift"
  end
